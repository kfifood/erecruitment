    ...
    <table id="jobsTable" class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('jobs.show.public', $job->id) }}" 
                            ...
                            <div class="modal-body row">
                                ...
                                <div class="mb-3 col-12">
                                    <label for="address{{ $job->id }}" class="form-label">Address</label>
                                        <textarea class="form-control" id="address{{ $job->id }}" name="address" rows="2" readonly>Kab. Tuban, Jawa Timur</textarea>
                                        <small class="text-muted">Regency of Company address</small>
                                </div>
                                
                                <div class="mb-3 col-12">
                                    <label for="full_address{{$job->id}}" class="form-label">Address</label>
                                        <textarea class="form-control" id="full_address{{ $job->id }}" name="full_address" rows="2" readonly>Jalan Raya Pakah-Ponco Km. 15+700, Sumberagung, Kec. Plumpang, Kab. Tuban </textarea>
                                        ...
                                        @foreach(['SMP', 'SMA', 'SMK', 'D3', 'D4', 'S1', 'S2'] as $level)
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" 
                                                    ...
                                                    id="edu_{{ $level }}{{ $job->id }}" 
                                                    value="{{ $level }}"
                                                    {{ $job->educations->contains('level', $level) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="edu_{{ $level }}{{ $job->id }}">{{ $level }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <textarea class="form-control rich-text-editor" id="description{{ $job->id }}" 
                                              name="description" rows="5">{{ $job->description }}</textarea>
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="qualification{{ $job->id }}" class="form-label">Qualification & Requirements</label>
                ...
                <div class="modal-body row">
                    ...
                    <div class="mb-3 col-12">
                        <label for="address" class="form-label">Address</label>
                            <textarea class="form-control" id="address" name="address" rows="2" readonly>Kab. Tuban, Jawa Timur</textarea>
                            <small class="text-muted">Regency of Company address</small>
                    </div>
                    <div class="mb-3 col-12">
                        <label for="full_address" class="form-label">Full Address</label>
                            <textarea class="form-control" id="full_address" name="full_address" rows="2" readonly>Jalan Raya Pakah-Ponco Km. 15+700, Sumberagung, Kec. Plumpang, Kab. Tuban  </textarea>
                        <small class="text-muted">Detailed address of the job location</small>
                   </div>
                    <div class="mb-3 col-md-6">
                    ...
                    <div class="mb-3 col-12">
                        ...
                        <textarea class="form-control rich-text-editor" id="description" name="description" rows="5"></textarea>
                    </div>
                    <div class="mb-3 col-12">
                        <label for="qualification" class="form-label">Qualification & Requirements</label>
                        <textarea class="form-control rich-text-editor" id="qualification" name="qualification" rows="5"></textarea>
                        <small class="text-muted">Use bullet points or numbering for requirements</small>
                    </div>
                </div>
                <div class="modal-footer">
